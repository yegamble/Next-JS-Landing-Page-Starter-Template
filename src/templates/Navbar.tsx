...
import AppIcon from 'public/assets/svgs/iota.svg';
            ...
            <div className="flex h-16 justify-between">
              <div className="flex">
                ...
                <div className="flex shrink-0 items-center">
                  <Bars3Icon className="mr-6" />
                  <AppIcon
                    className="size-12 text-indigo-600"
                    alt="IOTA stream logo"
                  />
                </div>
                <div className="m-auto w-full max-w-lg lg:max-w-xs">
                  <label htmlFor="search" className="sr-only">
                    Search
                  </label>
                  <div className="text-black-400 relative focus-within:text-gray-600">
